  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "accent-rose-dark": "hsl(var(--accent-rose-dark))",
        "accent-plum": "hsl(var(--accent-plum))",
      },
      fontFamily: {
        elegant: ['Cormorant Garamond', 'serif'],
        body: ['Inter', '-apple-system', 'BlinkMacSystemFont', '"Segoe UI"', 'sans-serif'],
        playfair: ['Cormorant Garamond', 'serif'], // Mantido para compatibilidade
        inter: ['Inter', '-apple-system', 'BlinkMacSystemFont', '"Segoe UI"', 'sans-serif'], // Mantido para compatibilidade
      },
      borderRadius: {
        lg: "var(--radius)",
